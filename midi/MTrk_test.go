...
var keysignatureFSM = &events.Event{
	Event: metaevent.MakeKeySignature(0, 0, 6, lib.Major, "F♯ major", []byte{0x00, 0xff, 0x59, 0x02, 0x06, 0x00}...),
}

var keysignatureEFm = &events.Event{
	Event: metaevent.MakeKeySignature(0, 0, -6, lib.Minor, "E♭ minor", []byte{0x00, 0xff, 0x59, 0x02, 0xfa, 0x01}...),
}
