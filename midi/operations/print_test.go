...
4D 54 72 6B 00 00 00 40…                    MTrk 1  length:64
...
83 60 80 30 40                              tick:720        delta:480        80 NoteOff            channel:0  note:XX, velocity:64
...
func TestPrintSMF(t *testing.T) {
	bytes := []byte{
		...
		0x00, 0xFF, 0x2F, 0x00,
		0x4d, 0x54, 0x72, 0x6b, 0x00, 0x00, 0x00, 0x40,
